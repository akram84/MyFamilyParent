...
import 'package:my_family/data/model/chat/message.dart';
...
import '../../../../../core/cubit/chat/chat/chat_cubit.dart';
...
class ChatScreen extends StatefulWidget {
  const ChatScreen({Key? key, required this.selectedChat, this.context}) : super(key: key);
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void dispose() {
    SocketIO.disconnect();
    if(widget.context != null) BlocProvider.of<ChatsCubit>(widget.context!).init(widget.context);
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => ChatCubit()..init(context, widget.selectedChat),
                ...
                children: [
                  Container(
                    ...
                    child: AppImage(
                      width: 45.w,
                      height: 45.h,
                      image: widget.selectedChat.senderImage,
                    ),
                  ),
                  10.widthBox,
                  AppText(
                    text: widget.selectedChat.senderName,
