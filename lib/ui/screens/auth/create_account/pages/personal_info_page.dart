...
class PersonalInfoPage extends GetView<CreateAccountController> {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppText.medium(
                          text: 'connect_with_family_today',
                          color: AppColors.colorSubText1),
                      Container(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              textInputAction: TextInputAction.go,
                              controller: controller.otherParentNameController,
                              keyboardType: TextInputType.text,
                              cursorColor: AppHelper.getAppTheme(),
                              cursorWidth: 1.3.w,
                              cursorRadius: const Radius.circular(26).r,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              textInputAction: TextInputAction.go,
                              controller: controller.otherParentEmailController,
                              keyboardType: TextInputType.emailAddress,
                              cursorColor: AppHelper.getAppTheme(),
                              cursorWidth: 1.3.w,
                              cursorRadius: const Radius.circular(26).r,
                      ...
                      Container(
                        ...
                        child: AppWidgets.CustomButton(
                            ...
                            isUpperCase: false,
                            text: 'next'.tr,
                            click: () => controller.verifyPersonalInfo()),
                      ),
                    ],
                  ),
                ),
  ...
  Widget buildsuffixIcon() => Container(
        width: 60.w,
        margin: const EdgeInsetsDirectional.only(end: 10),
        child: Row(
          children: [
            SvgPicture.asset('${Const.icons}check.svg'),
            2.widthBox,
            AppText.medium(
                text: 'admin',
                fontWeight: FontWeight.w400,
